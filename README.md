...
1. **Clone repository**
```bash
git clone https://github.com/yourusername/wedding-photos-project.git
...
พัฒนาโดย **CHAODOI-AI** ด้วยความชำนาญและความรักในเทคโนโลยี AI และการพัฒนาเว็บแอปพลิเคชัน
